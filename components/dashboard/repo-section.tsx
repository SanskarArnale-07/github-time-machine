              ...
              {displayedRepos.map((repo, index) => (
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <div className="mt-7 flex flex-col gap-3">
                    ...
                    <Button onClick={() => router.push(`/repo/${repo.full_name}/documentary?returnTo=${encodeURIComponent("/dashboard#repos")}`)} variant="outline" size="sm" className="w-full h-11 sm:h-9 text-xs font-medium border-white/20 text-muted/90 hover:border-white/40 hover:text-white bg-transparent hover:bg-white/5 transition-all duration-300 hover:shadow-[0_0_15px_rgba(255,255,255,0.07)]">
